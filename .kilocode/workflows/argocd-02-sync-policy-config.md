# ArgoCD Sync Policy Configurator

Generate or modify ArgoCD Application sync policies and options for specific deployment behaviors.

**Category:** deployment | **Tags:** argocd, kubernetes, gitops, sync, policy | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml
