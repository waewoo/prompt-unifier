...
Generate comprehensive unit tests for a given Python function or class using the pytest framework.

**Category:** testing | **Tags:** python, testing, pytest, unit-test, quality | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** python
