# Airflow DAG Refactoring Assistant

Refactor an existing Airflow DAG to align with best practices for performance, readability, and maintainability.

**Category:** development | **Tags:** airflow, dag, refactoring, python, optimization | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** python
