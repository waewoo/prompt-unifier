# Terraform State Migration Assistant

Generate Terraform CLI commands and HCL code to perform state migrations, refactoring, or resource imports.

**Category:** development | **Tags:** terraform, state, migration, cli, refactoring | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** hcl
