# Kubernetes Kustomize Overlay Generator

Generate a Kustomize overlay to customize a base set of Kubernetes manifests for a specific environment or purpose.

**Category:** development | **Tags:** kubernetes, kustomize, generator, yaml, configuration-management | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml
