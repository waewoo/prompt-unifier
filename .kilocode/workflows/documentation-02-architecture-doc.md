# Documentation Architecture Generator

Generate a high-level architecture document for a given system or application.

**Category:** documentation | **Tags:** documentation, architecture, design, system, generator | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** markdown
