...
Analyze Python code to identify common security vulnerabilities and suggest fixes.

**Category:** security | **Tags:** python, security, audit, sast, vulnerabilities, generator | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** python
