...
Generate a complete, idempotent Ansible playbook for a given configuration task.

**Category:** development | **Tags:** ansible, playbook, generator, yaml, configuration-management | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml
