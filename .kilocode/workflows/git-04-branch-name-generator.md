...
Generate a Git branch name that complies with the project's conventions.

**Category:** development | **Tags:** git, branch, generator, standards | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** en
