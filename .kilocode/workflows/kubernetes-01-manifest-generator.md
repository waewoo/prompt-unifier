...
Generate Kubernetes YAML manifests for common resources (Deployment, Service, Ingress, ConfigMap, Secret, etc.).

**Category:** development | **Tags:** kubernetes, manifest, generator, yaml, deployment | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml
