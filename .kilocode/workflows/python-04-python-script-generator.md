...
Generate a standalone Python script for a specific task, including argument parsing and best practices.

**Category:** development | **Tags:** python, script, generator, cli, automation | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** python
