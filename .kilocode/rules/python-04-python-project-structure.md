...
Standards for structuring Python applications and libraries to ensure consistency and maintainability.

**Category:** standards | **Tags:** python, project, structure, packaging, standards, poetry, pyproject | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** python | **AppliesTo:** pyproject.toml, setup.cfg, setup.py
