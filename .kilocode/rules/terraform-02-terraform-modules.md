...
Best practices for designing, developing, and consuming reusable Terraform modules.

**Category:** infrastructure | **Tags:** terraform, modules, standards, reusability, versioning | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** hcl | **AppliesTo:** modules/**/*.tf
