...
Standards for structuring Ansible playbooks to ensure readability, maintainability, and idempotence.

**Category:** standards | **Tags:** ansible, playbook, standards, configuration-management | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml | **AppliesTo:** **/*.yml, **/*.yaml
