...
Best practices for using Helm and Kustomize to manage Kubernetes manifests, and guidelines for choosing between them.

**Category:** deployment | **Tags:** kubernetes, helm, kustomize, standards, configuration-management | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** yaml | **AppliesTo:** helm/**/*.yaml, k8s/**/*.yaml
