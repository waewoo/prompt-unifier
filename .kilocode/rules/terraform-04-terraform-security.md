...
Guidelines for writing secure Terraform configurations and managing infrastructure security.

**Category:** security | **Tags:** terraform, security, iam, secrets, sast | **Version:** 1.0.0 | **Author:** prompt-unifier | **Language:** hcl | **AppliesTo:** **/*.tf
